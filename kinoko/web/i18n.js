...
(function () {
  ...
  var DICT = {
    ...
    "ゲームであそぶ": "Games",
    "4つ": "4",
    "GAME ― あそぶ（5つのゲーム）": "GAME ― Play (5 games)",
    "名前あて": "Name it",
    ...
    /* きのこマッチパズル */
    "胞子": "Spores", "のこり時間": "Time left", "のこり手数": "Moves left",
    "あそびかたを えらぶ": "Choose how to play",
    "👣 手数モード": "👣 Move mode", "⏱ タイムアタック": "⏱ Time attack",
    "30手で どれだけ育てられるか": "How much can you grow in 30 moves?",
    "90秒で どれだけ育てられるか": "How much can you grow in 90 seconds?",
    "保留（ホールド）": "Hold",
    "えらんで押すと しまう（タダ）": "Pick one to stash (free)",
    "もどす場所を おしてね": "Tap where to put it back",
    "もどす場所を おしてね（1手）": "Tap where to put it back (1 move)",
    ...
    "やめた": "Cancelled", "まぜ直した！": "Reshuffled!", "1つ消した！": "Removed!",
    "手数が 3 ふえた！": "3 more moves!", "じかんが 15秒 ふえた！": "15 more seconds!",
    "手数モード　": "Move mode　", "タイムアタック　": "Time attack　",
    ...
    /* ── このキノコなに？／グッズ ── */
    "このキノコ なに？": "What mushroom is this?",
    "このキノコ なに？ ｜ イワオトキノコ": "What mushroom is this? ｜ IWAO to KINOKO",
    "ASK ― このキノコなに？": "ASK ― What mushroom is this?",
    "GOODS ― グッズ": "GOODS ― Shop",
    "山で見つけたキノコの写真を送ってください。": "Send a photo of a mushroom you found in the mountains.",
    "長岡の山を十年以上歩いてきた石原巖が、分かる範囲でコメントでお答えします。":
      "Iwao Ishihara, who has walked the mountains of Nagaoka for over ten years, will answer in the comments as best he can.",
    "食べてよいという保証ではありません": "not a guarantee that it is safe to eat",
    "写真を送る": "Send a photo",
    "📷 写真をえらぶ": "📷 Choose a photo",
    "📷 写真をえらび直す": "📷 Choose a different photo",
    "なまえ（12文字まで・ニックネームで構いません）": "Your name (up to 12 characters; a nickname is fine)",
    "見つけた場所（だいたいで結構です）": "Where you found it (roughly is fine)",
    "気づいたこと・聞きたいこと": "What you noticed, or what you want to ask",
    "送る": "Send",
    "みんなの質問": "Everyone's questions",
    "まだ投稿がありません。いちばんのりになりませんか。": "No posts yet — would you like to be the first?",
    "投稿の受け付けはまだ準備中です。しばらくお待ちください。": "Posting is not open yet. Please check back soon.",
    ...
    "準備中": "Coming soon",
    "購入する →": "Buy →",
    "この絵について": "About the artwork",
    "Tシャツ": "T-shirt", "トートバッグ": "Tote bag", "手ぬぐい": "Tenugui cloth",
    "マグカップ": "Mug", "ステッカー": "Stickers", "写真集（準備中）": "Photo book (coming soon)",
    "HOME": "HOME", "ASK": "ASK", "GOODS": "GOODS",
